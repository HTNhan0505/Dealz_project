...
import 'package:dealz_app/views/d5_q5_step_2.dart';
...
class D5Q5 extends StatefulWidget {
  ...
  @override
  State<D5Q5> createState() => _D5Q5State();
}

class _D5Q5State extends State<D5Q5> {
                ...
                ? GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          PageRouteBuilder(
                            pageBuilder: (_, __, ___) => D5Q5Step2(
                                autoCountDown: true,
                                nameQuest:
                                    'Buớc 2, tìm chìa khoá điện tử của chiếc xe bên duới hộc chữa cháy. Mở cốp xe, tìm một chiếc hộp đuợc cất giữ trong ngăn bí mật dưới sàn xe. Bạn có 30 phút để thực hiện Quest này.',
                                showNextBtn: true,
                                titleQuest: 'QUEST 5',
                                nameBtn: 'HOÀN THÀNH'),
                          ));
